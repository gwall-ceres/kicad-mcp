#!/usr/bin/env python3
"""
Direct test of KiCAD adapter without full MCP server dependencies
"""
import sys
...
# Direct imports to avoid server dependencies
...
def test_kicad_adapter():
    ...
    print("=" * 70)
    print("TESTING KICAD SCHEMATIC DSL - DIRECT ADAPTER TEST")
    print("=" * 70)
    print()
