...
def register_export_tools(mcp: FastMCP) -> None:
    ...
    @mcp.tool()
    async def generate_pcb_thumbnail(project_path: str, ctx: Context | None) -> Image | None:
    ...
    @mcp.tool()
    async def generate_project_thumbnail(project_path: str, ctx: Context | None) -> Image | None:
...
async def generate_thumbnail_with_cli(pcb_file: str, ctx: Context | None) -> Image | None:
